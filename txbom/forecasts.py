...
def get_forecast(forecast_id):
    ...
    try:
        ...
        logging.debug("Forecast retrieval was successful")
        ...
        logging.error("Connection to forecast FTP server failed: %s" % str(ex))
...
def expand_contractions(data):
    ...
    contractions used in forecast reports.
    """
...
def forecastToDict(forecast):
    """
    Extract as much information as possible from the forecast text
    and return it in a dict format with unique keys suitable for
    use in a string Template substitution.
    """
